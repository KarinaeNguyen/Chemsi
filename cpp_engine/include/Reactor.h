...
public:
    ...
    // Overload: applies combustionHeatMultiplier_0_1 (0..1) to the *thermal* coupling of combustion HRR.
    // outCombustionHRR_W returns the raw combustion HRR before multiplier.
    void step(double dt,
              double inhibitor_kg_per_m3,
              double externalCooling_W,
    ...
    // Overload: supplies a kinetics ignition assist temperature floor for combustion.
    // This affects only the Arrhenius term used for reaction rates, not the bulk thermal state.
    void step(double dt,
              double inhibitor_kg_per_m3,
              double externalCooling_W,
              double combustionHeatMultiplier_0_1,
